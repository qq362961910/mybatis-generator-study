...
import mybatis3.ExtendedUpdateByExampleSelectiveElementGenerator;
...
public class ExtendedXMLMapperGenerator extends XMLMapperGenerator {
    ...
    protected void addUpdateByExampleSelectiveElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateUpdateByExampleSelective()) {
            AbstractXmlElementGenerator elementGenerator = new ExtendedUpdateByExampleSelectiveElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
